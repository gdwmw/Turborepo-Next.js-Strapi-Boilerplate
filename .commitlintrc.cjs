...
module.exports = {
  ...
  prompt: {
    ...
    messages: {
      ...
      scope:
        "What is the scope or issue of this change (e.g. utils or #123) (optional):",
    ...
    types: [
      ...
      {
        value: "refactor",
        name: "refactor: 💡   Code changes that do not fix bugs or add features",
        emoji: "💡",
      },
      {
        value: "perf",
        name: "perf:     ⚡️  Code changes that improve performance",
        emoji: "⚡️",
      },
      {
        value: "test",
      ...
      {
        value: "chore",
        name: "chore:    ⚙️  Other changes that do not modify the src or test files",
        emoji: "⚙️",
      },
      {
        value: "build",
        name: "build:    📦️   Changes that affect the build system or dependencies",
        emoji: "📦️",
      },
      {
        value: "docs",
      ...
      {
        value: "ci",
        name: "ci:       ♾️  Changes to configuration files and CI scripts",
        emoji: "♾️",
      },
      {
        value: "revert",
